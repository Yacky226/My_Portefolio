...
export function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="py-20 bg-surface/30 section-reveal" style={{ backgroundColor: 'rgba(11, 18, 32, 0.3)' }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select name="budget" value={formData.budget} onValueChange={(value: string) => handleInputChange('budget', value)} >
                        <SelectTrigger id="budget" className="bg-bg border-border" style={{ backgroundColor: 'var(--bg)', borderColor: 'var(--border)', color: 'var(--text)' }}>
